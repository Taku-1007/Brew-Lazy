...
import 'package:first_app/bloom_6screen/bloom_6.dart';
...
class BloomScreenfifth extends StatefulWidget {
  const BloomScreenfifth({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<BloomScreenfifth> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const BloomScreensixth(),
