...
import 'dart:async';
import 'package:first_app/bloom_3screen/bloom_3.dart';
import 'package:first_app/bloom_6iscreen/bloom_6i.dart';
...
class BloomicedScreenfifth extends StatefulWidget {
  const BloomicedScreenfifth({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<BloomicedScreenfifth> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const BloomicedScreensixth(),
