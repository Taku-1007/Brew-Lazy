...
class TimerRectanglethirty extends StatefulWidget {
  const TimerRectanglethirty({Key? key}) : super(key: key);

  @override
  TimerRectangleState createState() => TimerRectangleState();
}

class TimerRectangleState extends State<TimerRectanglethirty> {
  int _seconds = 30;
  Timer? _timer;
