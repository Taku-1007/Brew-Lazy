...
import 'package:first_app/bloom_4screend/bloom_4.dart';
...
class BloomScreenthird extends StatefulWidget {
  const BloomScreenthird({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<BloomScreenthird> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const BloomScreenfourth(),
