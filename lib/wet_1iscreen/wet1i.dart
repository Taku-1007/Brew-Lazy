...
import 'package:first_app/wet_2iscreen/wet2i.dart';
import 'dart:async';
...
void onTapRightIcon(BuildContext context) {
  ...
  Navigator.push(
    ...
    PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) =>
          const WettingthefiltericedScreensecond(),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        final curvedAnimation = CurvedAnimation(
          parent: animation,
          curve: const Interval(0.0, 1.0, curve: Curves.easeInOut),
...
class WettingthefiltericedScreen extends StatefulWidget {
  const WettingthefiltericedScreen({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<WettingthefiltericedScreen> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const WettingthefiltericedScreensecond(),
