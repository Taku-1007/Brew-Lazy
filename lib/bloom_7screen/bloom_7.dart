...
import 'package:first_app/bloom_8screen/bloom_8.dart';
...
class BloomScreenseventh extends StatefulWidget {
  const BloomScreenseventh({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<BloomScreenseventh> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const BloomScreeneighth(),
