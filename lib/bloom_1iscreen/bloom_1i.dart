...
import 'dart:async';
import 'package:first_app/bloom_2iscreen/bloom_2i.dart';
...
class BloomicedScreen extends StatefulWidget {
  const BloomicedScreen({Key? key}) : super(key: key);

  @override
  WettingthefilterScreenState createState() => WettingthefilterScreenState();
}

class WettingthefilterScreenState extends State<BloomicedScreen> {
  @override
  void initState() {
    super.initState();
    Timer(const Duration(seconds: 1), () {
      Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const BloomicedScreensecond(),
