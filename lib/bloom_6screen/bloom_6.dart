...
import 'package:first_app/bloom_7screen/bloom_7.dart';
...
class BloomScreensixth extends StatelessWidget {
  const BloomScreensixth({Key? key}) : super(key: key);
